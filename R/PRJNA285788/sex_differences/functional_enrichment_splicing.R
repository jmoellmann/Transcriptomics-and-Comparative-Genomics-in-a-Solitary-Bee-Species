...
for(ontology in c("CC", "MF", "BP")){
  ...
  dir.create(paste0("04_results/PRJNA285788/sex_differences/funct_enrich/", ontology), 
             showWarnings = FALSE, recursive = TRUE)
  
  res_all <- read_csv("04_results/PRJNA285788/sex_differences/diff_splicing/res_all.csv")
  ...
  write_tsv(gsea_ns20, paste0("04_results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
                              ontology, "/gsea_dm_ns20.tsv"))
  # write_tsv(gsea_ns50, paste0("results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #                             ontology, "/gsea_dm_ns50.tsv"))
  # write_tsv(gsea_ns100, paste0("results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #                              ontology, "/gsea_dm_ns100.tsv"))
  # write_tsv(gsea_ns150, paste0("results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #                              ontology, "/gsea_dm_ns150.tsv"))
  # 
  # write_tsv(gsea_bt_ns10, paste0("results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #                                ontology, "/gsea_bt_ns10.tsv"))
  # write_tsv(gsea_bt_ns20, paste0("results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #                                ontology, "/gsea_bt_ns20.tsv"))
  
  # write_tsv(gsea_imm_gene_ns10, paste0(
  #   "results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #   ontology, "/gsea_imm_gene_ns10.tsv"))
  write_tsv(gsea_imm_gene_ns20, paste0(
    "04_results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
    ontology, "/gsea_imm_gene_ns20.tsv"))
  # write_tsv(gsea_imm_gene_ns50, paste0(
  #   "results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #   ontology, "/gsea_imm_gene_ns50.tsv"))
  # write_tsv(gsea_imm_gene_ns100, paste0(
  #   "results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #   ontology, "/gsea_imm_gene_ns100.tsv"))
  # write_tsv(gsea_imm_gene_ns150, paste0(
  #   "results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
  #   ontology, "/gsea_imm_gene_ns150.tsv"))
  
  # write_tsv(gsea_imm_gene_bt_ns10, 
  #           paste0("results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
