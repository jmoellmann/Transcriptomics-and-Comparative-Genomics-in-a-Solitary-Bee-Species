...
#SBATCH -v
#SBATCH -o star_before_trimming.%j.out
#SBATCH -e star_before_trimming.%j.err
...
do
	...
	STAR_OUT_DIR=${PROJECT_DIR}/results/PRJNA533756/before_trimming/alignment/${GROUP}
