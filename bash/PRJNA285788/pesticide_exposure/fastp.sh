...
do
	...
	FASTQ_DATA_DIR=${EXPERIMENT_DIR}/pesticide_exposure/fastq-files/${GROUP}
	FASTP_OUT_DIR=${EXPERIMENT_DIR}/pesticide_exposure/fastp-trimmed/${GROUP}
	REPORT_OUT_DIR=${PROJECT_DIR}/results/PRJNA285788/pesticide_exposure/after_trimming/quality/fastp/${GROUP}
