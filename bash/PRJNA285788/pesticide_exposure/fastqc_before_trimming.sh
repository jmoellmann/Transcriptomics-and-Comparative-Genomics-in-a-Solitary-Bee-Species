...
do
	...
	DATA_DIR=${EXPERIMENT_DIR}/pesticide_exposure/fastq-files/${GROUP}
	REPORT_OUT_DIR=${PROJECT_DIR}/results/PRJNA285788/pesticide_exposure/before_trimming/quality/fastqc/${GROUP}
