...
#SBATCH -J qualimap_before_trimming
...
#SBATCH -v
#SBATCH -o qualimap_before_trimming.%j.out
#SBATCH -e qualimap_before_trimming.%j.err
...
do
	...
	BAM_DATA_DIR=${PROJECT_DIR}/results/drone_vs_worker/before_trimming/alignment/${GROUP}
	BAM_QC_OUT_DIR=${PROJECT_DIR}/results/drone_vs_worker/before_trimming/quality/qualimap/bamqc/${GROUP}
	RNA_SEQ_QC_OUT_DIR=${PROJECT_DIR}/results/drone_vs_worker/before_trimming/quality/qualimap/rnaseq/${GROUP}
